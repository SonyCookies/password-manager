                        ...
                        <form
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('site_name', $password->site_name ?? '') }}" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('site_url', $password->site_url ?? '') }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                                <input type="email"
                                    class="form-control mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    id="email" name="email" value="{{ old('email', $password->email ?? '') }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('password', $password->password ?? '') }}" required>
                            </div>
                            <button type="submit"
                                class="btn btn-primary bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-md">{{ isset($password) ? 'Update Password' : 'Save Password' }}</button>
                        </form>
                    </div>
                </div>
            </div>
